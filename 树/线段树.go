...
// o=1  [l,r] 1<=l<=r<=n  从节点t[o]开始查询区间[l, r]的值，可以是和，可以是最大值，最小值等等，可以修改op方法
...
func main() {
	res := make([]int, 0)
	res = append(res, []int{93, 90, 50, 100, 1}...)
	seg := newSegmentTree(res)
	fmt.Println(seg.query(1, 1, 1))
